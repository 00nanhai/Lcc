				      ...
				      ...)
{
	...
	switch(a_priority)
	{
		case 1: my_priority = 300; break;
		case 2: my_priority = 400; break;
		case 3: my_priority = 600; break;
		case 4: my_priority = 700; break;
		default: my_priority = 300;
	}

    if (log4c_category_is_priority_enabled(a_category, my_priority)) {
	va_list va;
	va_start(va, a_format);
	log4c_category_vlog(a_category, my_priority, a_format, va);
	va_end(va);
    }
}
